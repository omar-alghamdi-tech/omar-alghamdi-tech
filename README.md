...
![CEH](https://img.shields.io/badge/EC--Council-CEH-black?style=for-the-badge&logo=eccouncil&logoColor=white)
![eJPT](https://img.shields.io/badge/INE-eJPT-000000?style=for-the-badge&logo=linux&logoColor=white)
![OCI](https://img.shields.io/badge/Oracle-OCI_Foundations-C74634?style=for-the-badge&logo=oracle&logoColor=white)

---

### 📊 SOC & Threat Hunting Portfolio

| Lab & Documentation | Attack Vector / Tool | Detection Focus |
|---------------------|----------------------|-----------------|
| [SMB Brute-Force & Evasion Lab](https://github.com/omar-alghamdi-tech/smb-threat-hunting-lab) | SMB Protocol / NetExec | Windows Event Logs (4625, 4624) |
| [LSASS Credential Dumping Lab](https://github.com/omar-alghamdi-tech/lsass-credential-dumping-lab) | OS Credential Dumping | Endpoint Telemetry & Sysmon |
| [IBM QRadar AQL Cheat Sheet](https://github.com/omar-alghamdi-tech/qradar-aql-firewall-cheatsheet) | Firewall Log Analysis | SIEM Querying (AQL) |
